...
public class FournisseurController {
    ...
    @Tag(name = "Create Fournisseur", description = "Create a new supplier")
    @PostMapping
    ...
    @Tag(name = "Get All Fournisseurs", description = "Retrieve a list of all suppliers")
    @GetMapping
    public List<Fournisseur> findAll() {
        return fournisseurServiceImp.findAllFournisseurs();
    }

    @Tag(name = "Get Sorted Fournisseurs", description = "Retrieve all suppliers sorted by name in ascending order")
    @GetMapping("/sorted")
    ...
    @Tag(name = "Find Fournisseur by Name", description = "Retrieve a supplier by their name")
    @GetMapping("/nom/{nom}")
    public Fournisseur findByNom(@PathVariable("nom") String nom) {
        return fournisseurServiceImp.findFournisseurByNom(nom);
    }

    @Tag(name = "Delete Fournisseur", description = "Delete a supplier by ID")
    @DeleteMapping("/{id}")
    public void deleteFournisseur(@PathVariable("id") Long id) {
        fournisseurServiceImp.deleteFournisseurById(id);
    }

    @Tag(name = "Update Fournisseur", description = "Update an existing supplier by ID")
    @PutMapping("/{id}")
    ...
    @Tag(name = "Find Fournisseur by ID", description = "Retrieve a supplier using their unique ID")
    @GetMapping("/{id}")
